...
// 2019-01-07 18:29:23.209925 -0800 PST m=+0.010272010
package writers
...
func Routes(server page.Server, m page.Mux, renderer *treetop.Renderer) {
	...
	m.Handle("{{ $route.Path }}", treetop.ViewHandler({{ $route.Reference }}{{ range $index, $include := $route.Includes }}, {{ $include }}{{ end }})
