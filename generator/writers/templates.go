...
// 2018-09-19 16:18:03.760469 -0700 PDT m=+0.004023768
package writers
...
<div id="[[ .Extends ]]" class="block-extended">
    <p>View Fragment named [[.Name]]</p>[[ range $index, $block := .Blocks ]]
...
// {{ $handler.Info }} {{ $handler.Type }}{{ if $handler.Doc }}
// {{ $handler.Doc }}
...
<body>
    <ul class="page-nav nav">[[ range $link := .SiteLinks ]]
        [[ if $link.Active ]]<li><a treetop href="[[ $link.URI ]]">[[ $link.Label ]]</a></li>[[ else ]]
    ...
    {{ end }}
[[ end ]]
<script src="https://rawgit.com/rur/treetop-client/master/treetop.js"></script><script> treetop.init() </script>
</body>
</html>`
